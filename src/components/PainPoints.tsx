  ...
  const comparisons = [
    {
      ...
      problemDesc: "প্রচুর তথ্য ও বাজারের মোটা গাইডবুকের ভিড়ে কোন টপিক বুয়েট বা মেডিকেলের জন্য গুরুত্বপূর্ণ তা বুঝতে না পারা।",
      solutionTitle: "সুনির্দিষ্ট ও স্ট্রাকচার্ড কভারেজ",
      solutionDesc: "বুয়েট ও মেডিকেল ভর্তি পরীক্ষার কোয়েশ্চেন ব্যাংক এনালাইসিস করে তৈরি চ্যাপ্টার-বাই-চ্যাপ্টার ফোকাসড লেকচার ও রিভিশন নোট।",
    },
    {
    ...
    },
    {
      ...
      solutionDesc: "বুয়েট ও ঢাকা মেডিকেল কলেজের মেন্টরদের সরাসরি ১-অন-১ লাইভ ডাউট ক্লিয়ারিং ও টেলিগ্রাম প্রিমিয়াম চ্যানেল সাপোর্ট।",
    },
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="space-y-6">
          {comparisons.map((item, index) => (
            ...
            >
              {/* Problem Side (Crimson Accent) */}
              <div className="bg-[#121B2A]/90 p-6 sm:p-8 border-b lg:border-b-0 lg:border-r border-red-500/15 flex gap-4">
              ...
              {/* Solution Side (Emerald/Gold Accent) */}
              <div className="bg-gradient-to-br from-[#0E2847] to-[#0A223E] p-6 sm:p-8 flex gap-4 border-l-0 lg:border-l border-emerald-500/20">
